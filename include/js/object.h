...
typedef enum nodoka_completion(*nodoka_construct_func)(nodoka_global *global, nodoka_object *O, nodoka_data **ret, int argc, nodoka_data **argv);
typedef enum nodoka_completion(*nodoka_call_func)(nodoka_global *global, nodoka_object *O, nodoka_data *this, nodoka_data **ret, int argc, nodoka_data **argv);
...
enum nodoka_completion nodoka_call(nodoka_global *global, nodoka_object *O, nodoka_data *this, nodoka_data **ret, int argc, nodoka_data **argv);
enum nodoka_completion nodoka_construct(nodoka_global *global, nodoka_object *O, nodoka_data **ret, int argc, nodoka_data **argv);
